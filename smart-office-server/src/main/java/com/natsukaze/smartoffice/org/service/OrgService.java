package com.natsukaze.smartoffice.org.service;
...
import com.natsukaze.smartoffice.org.entity.OrgCompany;
import com.natsukaze.smartoffice.org.entity.OrgDepartment;
import com.natsukaze.smartoffice.org.entity.OrgEmployee;
import com.natsukaze.smartoffice.org.entity.OrgPosition;
import com.natsukaze.smartoffice.org.mapper.OrgCompanyMapper;
...
import com.natsukaze.smartoffice.org.mapper.OrgPositionMapper;
...
public class OrgService {
    ...
    public List<DepartmentTreeVO> departmentTree() {
        ...
        Map<Long, String> userNames = userMapper.selectBatchIds(departments.stream()
        ...
        List<DepartmentTreeVO> nodes = departments.stream()
                .map(dept -> toDepartmentTreeVO(dept, userNames.get(dept.getLeaderUserId())))
                .toList();
    ...
    private String leaderName(Long leaderUserId) {
        ...
        SysUser user = userMapper.selectById(leaderUserId);
